...
// Einheitliche Kachel-Komponente
    ...
    <div style={{ background: "var(--bg)", paddingTop: "70px" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <div style={{ maxWidth: "680px" }}>
            <div className="badge badge-blue animate-on-scroll" style={{ marginBottom: "1.25rem", fontSize: "0.8rem" }}>
              ✦ Versicherungen · Finanzen · Solaranlagen
            </div>
            <h1 className="animate-on-scroll stagger-1" style={{
            ...
            <p className="animate-on-scroll stagger-2" style={{
              ...
              Finde in wenigen Minuten den besten Tarif für Versicherungen, Finanzen und Solaranlagen.
            </p>
            <div className="animate-on-scroll stagger-3" style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", marginBottom: "2.5rem" }}>
              <Link href="/versicherungen/kfz" className="btn-primary">🚗 Kfz vergleichen</Link>
              <Link href="/solar/solar" className="btn-accent">☀️ Solaranlage vergleichen</Link>
              <Link href="#versicherungen" className="btn-ghost">Alle Vergleiche</Link>
            </div>

            {/* Stats */}
            <div className="animate-on-scroll stagger-4" style={{ display: "flex", flexWrap: "wrap", gap: "2rem" }}>
              {[
                ...
                <div key={s.label} style={{ display: "flex", flexDirection: "column", gap: "0.1rem" }}>
                  <span style={{ fontFamily: "var(--font-syne)", fontWeight: 700, fontSize: "1.4rem", color: "var(--primary)" }}>{s.val}</span>
      ...
      <section id="versicherungen" style={{ maxWidth: "1280px", margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        ...
        <div style={{
          ...
          {versicherungen.map((item) => (
            <CatCard key={item.slug} item={item} basePath="versicherungen" />
          ))}
        </div>
      </section>
      ...
      <section id="finanzen" style={{ maxWidth: "1280px", margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        ...
        <div style={{
          ...
          {finanzen.map((item) => (
            <CatCard key={item.slug} item={item} basePath="finanzen" />
          ))}
        </div>
      </section>
      ...
      <section id="solar" style={{ maxWidth: "1280px", margin: "0 auto", padding: "3.5rem 1.5rem" }}>
        <SectionHeader
          ...
          count={1}
        />
        <Link href="/solar/solar" style={{ textDecoration: "none", display: "block", maxWidth: "500px" }}>
          <div style={{
          ...
          >
            ...
            <p style={{ color: "#78350f", fontSize: "0.875rem", lineHeight: 1.6, marginBottom: "1rem" }}>
              Strom selbst erzeugen, Kosten senken und die Umwelt schützen. Jetzt Angebote für deine PV-Anlage vergleichen.
            </p>
      ...
      {/* ========== TRUST ========== */}
      <section style={{ background: "#f1f5f9", borderTop: "1px solid #e2e8f0", padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <h2 style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(1.5rem, 3vw, 2rem)", color: "#0f172a", letterSpacing: "-0.02em", marginBottom: "1.75rem", textAlign: "center" }}>
